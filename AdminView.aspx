...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <!-- AI Patient Triage - Appointments -->
    <h3 style="margin-top:30px;">Appointments <small style="color:#777;">AI Pre-Triage</small></h3>
    <p style="color:#555;">Triage levels are generated automatically by GPT-4 when patients submit their appointment form.</p>
    ...
    <asp:SqlDataSource ID="SqlDataSource5" runat="server"
        ...
        SelectCommand="SELECT FirstName, Lastname, Age, Services, PhoneNum, Issue, AITriage, AINote FROM [Appointments]">
    </asp:SqlDataSource>
